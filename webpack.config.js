...
Encore
    ...
    .addEntry('easing', './assets/js/jquery.easing.1.3.js')
    .addEntry('bootstrap', './assets/js/bootstrap.js')
    .addEntry('app', './assets/js/app.js')
    .addEntry('jcarousel', [
        './assets/js/jcarousel/jquery.jcarousel.min.js'])
    .addEntry('fancybox', [
    ...
    .addEntry('portfolio', [
        ...
        './assets/js/portfolio/setting.js'])
    .addEntry('slider', [
